function createTrenchOptions() {
    ...
    switch (fieldOrTrenches) {
        ...
        document.getElementById('trenchHeightDiv').innerHTML = ('Trench Height: <input type="number" id="UserInput-trenchHeight" required placeholder="feet" onblur="validateTrenchHeight()" min="0.5" max="2"><br>');
