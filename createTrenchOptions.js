function createTrenchOptions() {
    ...
    switch (fieldOrTrenches) {
        case 'Trenches': 
        document.getElementById('trenchWidthDiv').innerHTML = ('Trench Width: <input type="number" id="UserInput-trenchWidth" required placeholder="feet" onchange="validateTrenchWidth()" min="2" max="3"><br>');
        document.getElementById('trenchHeightDiv').innerHTML = ('Trench Height: <input type="number" id="UserInput-trenchHeight" required placeholder="feet" onchange="validateTrenchHeight()" min="0.5" max="2"><br>');
