...
function validateTrenchHeight() {
  ...
  if (trenchHeightValue < 0.5) {
    alert("Invalid Input: Per Title V section 15.251, the minimum trench height shall be 0.5 feet");
    document.getElementById('UserInput-trenchHeight').value = 0.5
  } else if (trenchHeightValue > 2) {
    alert("Invalid Input: Per Title V section 15.251, the maximum trench height shall be 2 feet");
