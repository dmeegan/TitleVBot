...
function createSoilClassOptions() {
    ...
    if (percRate <= 0) {
        ...
        document.getElementById("UserInput-soilClass").options.item(1).setAttribute("style", 'block');
        document.getElementById("UserInput-soilClass").options.item(2).setAttribute("style", 'block');
        ...
        document.getElementById("UserInput-soilClass").selectedIndex = '2'
        document.getElementById("UserInput-soilClass").options.item(2).setAttribute("style", 'block');
        document.getElementById("UserInput-soilClass").options.item(3).setAttribute("style", 'block');
        ...
        document.getElementById("UserInput-soilClass").selectedIndex = '3'
        document.getElementById("UserInput-soilClass").options.item(3).setAttribute("style", 'block');
        document.getElementById("UserInput-soilClass").options.item(4).setAttribute("style", 'block');
    } else if (percRate > 60) {
